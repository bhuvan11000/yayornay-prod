...
/**
 * Beams — animated arena floodlight beams on a dark screen
 * (a stadium Jumbotron behind the hero).
 * Vendored from ReactBits (JSX-ified, fiber PerspectiveCamera instead of drei).
 */
...
const DirLight = forwardRef(({ position, color }, ref) => {
