...
/**
 * ScrollVelocity — infinite marquee whose direction reacts to the
 * page's scroll velocity (a stadium ticker tape).
 * Vendored from ReactBits (adapted to framer-motion + JSX).
 */
